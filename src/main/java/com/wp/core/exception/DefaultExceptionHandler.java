...
public class DefaultExceptionHandler {
    ...
    public Result<?> handleThrowable(HttpServletRequest request, Throwable e) {
    ...
    public ModelAndView handleUnauthenticatedException(NativeWebRequest request, UnauthorizedException e) {
        ...
        mv.setViewName("base/unauthorized");
        return mv;
    }*/
...
//    public Result handleBizException(HttpServletRequest request, Exception e) {
//        LOGGER.error("execute methond exception error.url is {}", request.getRequestURI(), e);
